...
const server = http.createServer(async (req, res) => {
  ...
  if (method==='GET' && p.startsWith('/pimg/')) {
    ...
    const T = {
      'Celulares':        {a:'#007AFF',b:'#0A1628',c:'#0D2240',t:'#4DA6FF'},
      'Eletrodomésticos': {a:'#1565C0',b:'#E3F2FD',c:'#BBDEFB',t:'#0D47A1'},
      'TV e Vídeo':       {a:'#6200EA',b:'#0A0A14',c:'#12003A',t:'#BB86FC'},
      'Informática':      {a:'#00897B',b:'#0A1A18',c:'#0D2620',t:'#4DB6AC'},
      'Games':            {a:'#D500F9',b:'#0D001A',c:'#1A0028',t:'#EA80FC'},
      'Câmeras':          {a:'#BF360C',b:'#1A0A00',c:'#2A1000',t:'#FF8A65'},
      'Móveis':           {a:'#5D4037',b:'#FFF8F0',c:'#EFEBE9',t:'#3E2723'},
      'Fones':            {a:'#00BCD4',b:'#001A1F',c:'#002830',t:'#80DEEA'},
      'Smartwatches':     {a:'#E91E63',b:'#1A0010',c:'#280018',t:'#F48FB1'},
      'Tablets':          {a:'#1976D2',b:'#0A1628',c:'#0D2040',t:'#64B5F6'},
    };
    const th = T[cat] || {a:'#0086FF',b:'#0A1020',c:'#0D1830',t:'#4DA6FF'};

    // ── Per-product illustration based on ID prefix ──
    const prefix = pid.replace(/[0-9]/g,'');
    const drawings = {
      'C': `
        <rect x="148" y="44" width="104" height="192" rx="18" fill="${th.b}" stroke="${th.a}" stroke-width="2.5"/>
        <rect x="156" y="62" width="88" height="138" rx="9" fill="${th.c}"/>
        <rect x="185" y="50" width="30" height="5" rx="2.5" fill="${th.a}88"/>
        <circle cx="220" cy="52" r="4" fill="${th.a}88"/>
        <linearGradient id="sc" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="${th.a}33"/><stop offset="100%" stop-color="${th.a}11"/></linearGradient>
        <rect x="156" y="62" width="88" height="138" rx="9" fill="url(#sc)"/>
        <rect x="163" y="70" width="74" height="12" rx="3" fill="${th.a}44"/>
        <rect x="163" y="88" width="50" height="8" rx="3" fill="${th.a}22"/>
        <rect x="163" y="102" width="62" height="8" rx="3" fill="${th.a}22"/>
        <rect x="163" y="116" width="44" height="8" rx="3" fill="${th.a}22"/>
        <circle cx="200" cy="155" r="24" fill="${th.a}22" stroke="${th.a}55" stroke-width="1.5"/>
        <text x="200" y="162" font-size="22" text-anchor="middle" fill="${th.a}cc">📷</text>
        <circle cx="200" cy="228" r="10" fill="${th.b}" stroke="${th.a}" stroke-width="1.5"/>
        <circle cx="200" cy="228" r="4" fill="${th.a}66"/>
        <rect x="235" y="116" width="5" height="30" rx="2.5" fill="${th.a}99"/>
        <rect x="235" y="90" width="5" height="20" rx="2.5" fill="${th.a}66"/>`,

      'E': `
        <rect x="88" y="50" width="224" height="246" rx="14" fill="#E8EEF4" stroke="#B0BEC5" stroke-width="2"/>
        <rect x="100" y="62" width="200" height="120" rx="8" fill="#CFD8DC"/>
        <rect x="100" y="188" width="96" height="100" rx="6" fill="#B0BEC5"/>
        <rect x="204" y="188" width="96" height="100" rx="6" fill="#C0CAD0"/>
        <circle cx="128" cy="88" r="18" fill="#78909C" stroke="#546E7A" stroke-width="2.5"/>
        <circle cx="128" cy="88" r="8" fill="#37474F"/>
        <circle cx="128" cy="88" r="3" fill="#CFD8DC"/>
        <circle cx="168" cy="88" r="18" fill="#78909C" stroke="#546E7A" stroke-width="2.5"/>
        <circle cx="168" cy="88" r="8" fill="#37474F"/>
        <rect x="196" y="74" width="96" height="14" rx="4" fill="#90A4AE"/>
        <rect x="196" y="94" width="70" height="8" rx="3" fill="#78909C"/>
        <rect x="196" y="108" width="80" height="8" rx="3" fill="#78909C"/>
        <line x1="100" y1="186" x2="300" y2="186" stroke="#90A4AE" stroke-width="1.5"/>
        <circle cx="110" cy="240" r="8" fill="#546E7A"/>
        <circle cx="284" cy="240" r="8" fill="#546E7A"/>`,

      'T': `
        <rect x="58" y="80" width="284" height="172" rx="12" fill="#111" stroke="#222" stroke-width="2.5"/>
        <rect x="66" y="88" width="268" height="156" rx="8" fill="#0A0A1A"/>
        <linearGradient id="sc2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="${th.a}44"/><stop offset="50%" stop-color="${th.a}11"/><stop offset="100%" stop-color="${th.a}33"/></linearGradient>
        <rect x="66" y="88" width="268" height="156" rx="8" fill="url(#sc2)"/>
        <text x="200" y="178" font-size="48" text-anchor="middle" fill="white" opacity="0.7">▶</text>
        <rect x="66" y="88" width="268" height="28" rx="8" fill="#00000088"/>
        <rect x="78" y="98" width="80" height="8" rx="3" fill="white" opacity="0.4"/>
        <rect x="252" y="256" width="20" height="38" rx="6" fill="#111"/>
        <rect x="148" y="256" width="10" height="24" rx="3" fill="#111"/>
        <rect x="88" y="282" width="224" height="10" rx="5" fill="#111"/>
        <circle cx="310" cy="100" r="6" fill="${th.a}99"/>`,

      'I': `
        <rect x="80" y="106" width="240" height="156" rx="10" fill="#D8D8D8" stroke="#B8B8B8" stroke-width="1.5"/>
        <rect x="88" y="114" width="224" height="140" rx="7" fill="#222"/>
        <linearGradient id="sc3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="${th.a}55"/><stop offset="100%" stop-color="${th.a}11"/></linearGradient>
        <rect x="88" y="114" width="224" height="140" rx="7" fill="url(#sc3)"/>
        <rect x="96" y="120" width="208" height="22" rx="3" fill="${th.a}33"/>
        <circle cx="200" cy="131" r="6" fill="${th.a}88"/>
        <rect x="60" y="264" width="280" height="18" rx="6" fill="#C8C8C8"/>
        <rect x="148" y="256" width="104" height="12" rx="4" fill="#B8B8B8"/>
        <rect x="96" y="152" width="80" height="8" rx="3" fill="${th.a}44"/>
        <rect x="96" y="166" width="56" height="7" rx="3" fill="${th.a}33"/>
        <rect x="96" y="180" width="68" height="7" rx="3" fill="${th.a}33"/>
        <rect x="96" y="194" width="44" height="7" rx="3" fill="${th.a}33"/>`,

      'G': `
        <rect x="98" y="118" width="204" height="136" rx="26" fill="#0D0D0D" stroke="#1A1A1A" stroke-width="2.5"/>
        <circle cx="272" cy="162" r="11" fill="#E53935"/>
        <circle cx="254" cy="180" r="11" fill="#43A047"/>
        <circle cx="290" cy="180" r="11" fill="#1E88E5"/>
        <circle cx="272" cy="198" r="11" fill="#FB8C00"/>
        <text x="272" y="166" font-size="9" text-anchor="middle" fill="white" font-weight="bold">○</text>
        <text x="254" y="184" font-size="9" text-anchor="middle" fill="white" font-weight="bold">×</text>
        <text x="290" y="184" font-size="9" text-anchor="middle" fill="white" font-weight="bold">□</text>
        <text x="272" y="202" font-size="9" text-anchor="middle" fill="white" font-weight="bold">△</text>
        <rect x="118" y="158" width="50" height="32" rx="8" fill="#1A1A1A" stroke="#2A2A2A" stroke-width="1"/>
        <circle cx="130" cy="174" r="9" fill="#252525"/>
        <circle cx="153" cy="174" r="9" fill="#252525"/>
        <rect x="175" y="162" width="26" height="12" rx="4" fill="#1E1E1E" stroke="${th.a}44" stroke-width="1"/>
        <rect x="189" y="168" width="28" height="12" rx="4" fill="#1E1E1E" stroke="${th.a}44" stroke-width="1"/>
        <circle cx="200" cy="250" r="7" fill="${th.a}66"/>`,

      'F': `
        <path d="M152 152 Q200 62 248 152" fill="none" stroke="${th.b}" stroke-width="28" stroke-linecap="round"/>
        <path d="M152 152 Q200 65 248 152" fill="none" stroke="${th.a}" stroke-width="8" stroke-linecap="round"/>
        <rect x="127" y="148" width="42" height="72" rx="21" fill="${th.b}" stroke="${th.a}" stroke-width="2.5"/>
        <rect x="231" y="148" width="42" height="72" rx="21" fill="${th.b}" stroke="${th.a}" stroke-width="2.5"/>
        <ellipse cx="148" cy="184" rx="14" ry="28" fill="#0A0A14"/>
        <ellipse cx="252" cy="184" rx="14" ry="28" fill="#0A0A14"/>
        <circle cx="141" cy="176" r="5" fill="${th.a}55"/>
        <circle cx="259" cy="176" r="5" fill="${th.a}55"/>`,

      'K': `
        <rect x="108" y="88" width="184" height="148" rx="14" fill="#1A1A1A" stroke="#2A2A2A" stroke-width="2"/>
        <rect x="220" y="70" width="88" height="26" rx="8" fill="#111" stroke="#1E1E1E" stroke-width="1"/>
        <circle cx="200" cy="160" r="56" fill="#111" stroke="#2A2A2A" stroke-width="3"/>
        <circle cx="200" cy="160" r="42" fill="#0A0A0A" stroke="#333" stroke-width="2"/>
        <circle cx="200" cy="160" r="28" fill="#0D47A1"/>
        <circle cx="200" cy="160" r="14" fill="#1565C0"/>
        <circle cx="192" cy="152" r="6" fill="white" opacity="0.25"/>
        <rect x="108" y="88" width="88" height="26" rx="14" fill="#222"/>
        <rect x="290" y="138" width="8" height="44" rx="4" fill="#333"/>`,

      'M': `
        <rect x="78" y="168" width="244" height="120" rx="14" fill="#8D6E63" stroke="#6D4C41" stroke-width="2"/>
        <rect x="90" y="150" width="220" height="30" rx="12" fill="#A1887F"/>
        <path d="M90 168 Q90 182 78 188 L78 288 L90 288 L90 168" fill="#795548"/>
        <path d="M310 168 Q310 182 322 188 L322 288 L310 288 L310 168" fill="#795548"/>
        <rect x="88" y="286" width="26" height="52" rx="7" fill="#6D4C41"/>
        <rect x="286" y="286" width="26" height="52" rx="7" fill="#6D4C41"/>
        <rect x="148" y="286" width="26" height="36" rx="7" fill="#6D4C41"/>
        <rect x="226" y="286" width="26" height="36" rx="7" fill="#6D4C41"/>
        <rect x="100" y="158" width="64" height="18" rx="8" fill="#BCAAA4"/>
        <rect x="236" y="158" width="64" height="18" rx="8" fill="#BCAAA4"/>
        <rect x="104" y="186" width="192" height="86" rx="6" fill="#795548" opacity="0.4"/>`,

      'W': `
        <rect x="162" y="50" width="76" height="26" rx="7" fill="${th.b}" stroke="${th.a}55" stroke-width="1"/>
        <rect x="162" y="258" width="76" height="26" rx="7" fill="${th.b}" stroke="${th.a}55" stroke-width="1"/>
        <rect x="148" y="76" width="104" height="180" rx="26" fill="${th.b}" stroke="${th.a}" stroke-width="2.5"/>
        <rect x="160" y="90" width="80" height="152" rx="20" fill="#0A0A1A"/>
        <linearGradient id="wsc" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="${th.a}44"/><stop offset="100%" stop-color="${th.a}11"/></linearGradient>
        <rect x="160" y="90" width="80" height="152" rx="20" fill="url(#wsc)"/>
        <text x="200" y="158" font-family="Arial" font-size="24" font-weight="900" fill="white" text-anchor="middle">12:00</text>
        <text x="200" y="176" font-family="Arial" font-size="10" fill="${th.a}cc" text-anchor="middle">SEG, 6 MAR</text>
        <rect x="160" y="185" width="80" height="1.5" fill="${th.a}44"/>
        <rect x="164" y="192" width="50" height="9" rx="4.5" fill="${th.a}66"/>
        <rect x="164" y="206" width="34" height="9" rx="4.5" fill="${th.a}44"/>
        <circle cx="248" cy="166" r="7" fill="#1A1A2E" stroke="${th.a}" stroke-width="1.5"/>`,

      'TB': `
        <rect x="116" y="50" width="168" height="240" rx="18" fill="${th.b}" stroke="${th.a}" stroke-width="2.5"/>
        <rect x="126" y="64" width="148" height="210" rx="12" fill="#0A0A1A"/>
        <linearGradient id="tsc" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="${th.a}55"/><stop offset="100%" stop-color="${th.a}11"/></linearGradient>
        <rect x="126" y="64" width="148" height="210" rx="12" fill="url(#tsc)"/>
        <rect x="134" y="72" width="132" height="20" rx="4" fill="${th.a}33"/>
        <circle cx="200" cy="82" r="5" fill="${th.a}88"/>
        <rect x="283" y="148" width="5" height="40" rx="2.5" fill="${th.a}99"/>
        <rect x="283" y="110" width="5" height="26" rx="2.5" fill="${th.a}66"/>`,
    };

    const drawing = drawings[prefix] || drawings['C'];
...
<linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
  <stop offset="0%" stop-color="${th.b}"/>
  <stop offset="100%" stop-color="${th.c}"/>
</linearGradient>
</defs>
<rect width="400" height="400" fill="url(#bg)"/>
<circle cx="200" cy="186" r="150" fill="${th.a}08"/>
<circle cx="200" cy="186" r="100" fill="${th.a}05"/>
${drawing}
<rect x="0" y="272" width="400" height="128" fill="${th.b}F5"/>
<line x1="0" y1="273" x2="400" y2="273" stroke="${th.a}55" stroke-width="1"/>
<text x="200" y="288" font-family="Arial,sans-serif" font-size="10" font-weight="900" fill="${th.a}" text-anchor="middle" letter-spacing="3" opacity="0.9">${safeB.toUpperCase()}</text>
${nameLines}
<rect x="108" y="${baseY + lines.length*16 + 4}" width="184" height="38" rx="19" fill="${th.a}28" stroke="${th.a}66" stroke-width="1.5"/>
<text x="200" y="${baseY + lines.length*16 + 27}" font-family="Arial,sans-serif" font-size="15" font-weight="900" fill="${th.a}" text-anchor="middle">R$ ${pixPrice}</text>
<rect x="302" y="8" width="84" height="30" rx="10" fill="#E53935" opacity="0.95"/>
